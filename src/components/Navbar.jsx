...
const Navbar = () => {
    ...
    return (
        <div className="navbar">
            ...
            >
                <img className="nav-icon" src="src\assets\restaurants.png" width={25} />
            ...
            >
                <img className="nav-icon" src="src\assets\orders.png" width={25} />
            ...
            <Link
                ...
                >
                <img className="nav-icon" src="src\assets\returns.png" width={25} />
